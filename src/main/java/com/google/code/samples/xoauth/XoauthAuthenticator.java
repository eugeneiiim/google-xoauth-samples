...
public class XoauthAuthenticator {
   ...
   *     operations.
   */
  public static SMTPTransportAndSession connectToSmtp(String host,
                                            int port,
                                            String userEmail,
                                            String oauthToken,
                                            String oauthTokenSecret,
    ...
    SMTPTransportAndSession transportAndSession = new SMTPTransportAndSession();
    transportAndSession.smtpTransport = transport;
    transportAndSession.session = session;

    return transportAndSession;
  }

  /**
   * Authenticates to IMAP with parameters passed in on the commandline.
   */
  public static void main_DISABLED(String args[]) throws Exception {
    if (args.length != 3) {
      System.err.println(
    ...
    SMTPTransportAndSession smtpTransportAndSession = connectToSmtp("smtp.googlemail.com",
                                                587,
                                                email,
                                                oauthToken,
                                                oauthTokenSecret,
